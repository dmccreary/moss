...
| 2 | Chapters | 20 | Required | Chapter directories with index.md |
| 3 | MicroSims | 31 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 20 / 20 | Recommended | Chapters with a quiz.md (200 questions total) |
| 6 | Chapter References | 0 / 20 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 400 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 79 | Recommended | Questions in faq.md |
| 9 | Words | 152,592 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 29 | 29 | H4 headers starting with '#### Diagram:' |
| Equations | 0 | 0 | LaTeX expressions (inline and display) |
| Total Words | 152,592 | 104,012 | Words in markdown files |
| Links | 215 | 54 | Hyperlinks in markdown format |
| Equivalent Pages | 633 | 438 | Estimated pages (250 words/page + visuals) |
